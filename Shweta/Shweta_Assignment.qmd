---
title: "*Poatnatal Care around The world* "
format: html
execute:
  echo: false
  warning: false
...
```
### Postnatal Care Around The World: A look at treatment received by women
...
unicef_indicator_1 <- read.csv("/cloud/project/Shweta/Indicator.csv")
unicef_metadata <- read.csv("/cloud/project/Shweta/unicef_metadata.csv")
...
```{r}
# Create a bar chart
ggplot(unicef_indicator_1, aes(x = reorder(country, -obs_value), y = obs_value, fill = sex)) +
